...
//       return "N/A"; // Fallback for null, undefined, or non-string values
//     }
//     try {
//       const [time, date] = dateString.split(" ");
//       if (!time || !date) {
//         return "N/A"; // Fallback if split doesn't produce expected parts
//       }
//       const [day, month, year] = date.split("/");
//       if (!day || !month || !year) {
//         return "N/A"; // Fallback if date parts are missing
//       }
//       return `${day}/${month}/${year} ${time}`;
//     } catch (error) {
//       console.warn(`Invalid date format: ${dateString}`, error);
//       return "N/A"; // Fallback for any other parsing errors
//     }
//   };
