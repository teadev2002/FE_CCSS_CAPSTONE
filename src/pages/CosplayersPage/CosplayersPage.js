...
//       toast.info(
//         `Start time and end time cannot be the same for the following days: ${sameTimeRanges.join(
//           ", "
//         )}`
//       );
//       setIsSubmitting(false);
...
//     setCurrentStep(1);
//     try {
//       const startTime = performance.now(); // Define startTime for performance tracking
//       console.log("Sending request at:", performance.now() - startTime, "ms");
//       console.log("requestData:", JSON.stringify(requestData, null, 2));
//       const response = await HireCosplayerService.NewSendRequestHireCosplayer(
//         requestData
