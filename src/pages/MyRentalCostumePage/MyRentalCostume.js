...
// import ViewDeliveryRentalCostume from "./ViewDeliveryRentalCostume"; // Thêm import
...
//   const [isDeliveryModalVisible, setIsDeliveryModalVisible] = useState(false); // Thêm state cho modal View Delivery
...
//     }
//   };
//   // Hàm mở modal View Delivery
//   const handleViewDelivery = (contractId) => {
//     setSelectedContractId(contractId);
//     setIsDeliveryModalVisible(true);
//   };

//   // Hàm đóng modal View Delivery
...
//                                   <div className="text-muted small">
//                                     <DollarSign size={16} />
//                                     Refund Amount: {contract.amount}
//                                   </div>
//                                   <div className="text-muted small">
//                                     <Calendar size={16} />
//                                     Created Date: {contract.createDate}
//                                   </div>
//                                   <div className="text-muted small">
//                                     <User size={16} />
//                                     CreateBy : {contract.createBy}
...
//           style={{ width: "70%" }}
//         />
//         {/* Thêm modal ViewDeliveryRentalCostume */}
...
// them filter cho contract status ===============================================
// import React, { useState, useEffect } from "react";
// import { Container, Row, Col, Form, Card, Badge } from "react-bootstrap";
// import {
//   Pagination,
...
//     Cancel: true,
//   });
//   // New state for contract status filters
...
//     sortField,
//     sortOrder,
//     contractStatusFilters, // Add dependency
//   ]);
