...
import ViewContractEventOrganize from "./ViewContractEventOrganize.js"; // Giả định component xem chi tiết
...
const ManageContractEventOrganzie = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        // Fetch all contracts and filter by serviceId === "S003"
        try {
        ...
        try {
          ...
          if (isMounted) {
            ...
            if (formattedData.length === 0) {
              //           toast.info(
              //             "No requests with status Browsed and deposit > 1 found for Event Organize."
              //            );
            } else {
              toast.success(
...
export default ManageContractEventOrganzie;
