...
//   useEffect(() => {
//     // Lấy danh sách requestId từ contracts
//     const contractRequestIds = contracts.map((contract) => contract.requestId);

//     let filtered = requests
//       // Loại bỏ các request có requestId trùng với contract
...
//   }, [searchTerm, requests, sortOption, statusFilter, contracts]);
//   // Filter contracts
//   useEffect(() => {
...
//   // Handle cancel contract by opening modal
...
//   // CHANGE: Updated to encode reason and handle API errors
