...
const characters = [
  {
    ...
    description:
      "The Red Power Ranger is the leader of the Power Rangers team. Known for his courage and leadership skills, he commands respect from both teammates and enemies.",
  ...
  },
  {
    ...
    description:
      "Your friendly neighborhood Spider-Man! With the proportionate strength, speed, and agility of a spider, Peter Parker fights crime and saves lives.",
    abilities: [
      "Web-Slinging",
      "Spider Sense",
      "Super Strength",
  ...
  },
  {
    ...
    description:
      "Gotham's Dark Knight, Batman uses his intelligence, physical prowess, and arsenal of gadgets to fight crime and protect the innocent.",
    abilities: [
      "Detective Skills",
      "Martial Arts",
      "Advanced Technology",
  ...
  },
  {
    ...
    description:
      "The hyperactive ninja from the Hidden Leaf Village. Naruto's dream is to become the Hokage, the leader of his village.",
    abilities: [
      "Shadow Clone Jutsu",
      "Rasengan",
      "Sage Mode",
  ...
  },
  {
    ...
    description:
      "Diana Prince, an Amazonian warrior and princess, uses her superstrength, magical weapons, and sense of compassion to fight evil and protect the innocent.",
    abilities: [
      "Super Strength",
      "Lasso of Truth",
  ...
  },
  {
    ...
    description:
      "Genius, billionaire, playboy, philanthropist Tony Stark fights evil in his technologically advanced Iron Man suit.",
    abilities: [
      "Genius Intelligence",
      "Powered Armor",
      "Flight",
  ...
  },
  {
    ...
    description:
      "A skilled soldier from Attack on Titan, Mikasa is known for her exceptional combat abilities and unwavering loyalty to Eren Yeager.",
    abilities: [
      "Expert ODM Gear User",
  ...
  },
  {
    ...
    description:
      "Steve Rogers, a World War II veteran, fights for American ideals as the Super-Soldier Captain America.",
    abilities: [
      "Peak Human Strength",
  ...
  },
  {
    ...
    description:
      "Natasha Romanoff, a former KGB assassin, now uses her extraordinary skills as an Avenger to protect the world.",
    abilities: [
      "Espionage Expert",
  ...
  },
  {
    ...
    description:
      "The legendary hero of Hyrule, wielding the Master Sword to save the world.",
  ...
  },
  {
    ...
    description:
      "The Boy Who Lived, wielding magic and courage to defeat dark forces.",
  ...
  },
  {
    ...
    description:
      "The Dark Lord of the Sith, commanding the Galactic Empire with the Force.",
    abilities: [
      "Force Choke",
      "Lightsaber Combat",
      "Telekinesis",
  ...
  },
  {
    ...
    description:
      "The dream-haunting killer from Elm Street, wielding claws and nightmares.",
    abilities: [
      "Dream Manipulation",
      "Claw Attacks",
      "Invulnerability",
  ...
  },
  {
    ...
    description:
      "The iconic queen of Egypt, known for her intelligence and charm.",
    abilities: [
      "Political Strategy",
      "Charisma",
      "Diplomacy",
  ...
  },
  {
    ...
    description:
      "The Norse god of thunder, wielding Mjolnir to protect Asgard and Midgard.",
  ...
  },
  {
    ...
    description:
      "A Victorian-era inventor with steam-powered gadgets and Victorian attire.",
    abilities: [
  ...
  },
  {
    ...
    description:
      "The hacker-turned-hero in a dystopian future, mastering the Matrix.",
    abilities: [
      "Hacking Skills",
      "Martial Arts",
      "Matrix Control",
  ...
  },
  {
    ...
    description:
      "The cheerful sea sponge from Bikini Bottom, always ready for fun and adventure.",
