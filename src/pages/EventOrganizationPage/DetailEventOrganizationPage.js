...
//       (!location ||
//         !location.includes(", ") ||
//         !location.endsWith("TP.HCM") ||
//         !dateRange[0] ||
//         !dateRange[1] ||
//         !description)
//     ) {
//       toast.warn(
//         "Please select a district and street, and fill in all other required fields!"
//       );
//       return;
//     }
//     if (step === 2) {
...
//                   }}
//                   required
//                   className="custom-location-picker"
//                 />
//               </Form.Group>
//               <Form.Group className="mb-3">
//                 <Form.Label>Description</Form.Label>
...
//     if (
//       !data.location ||
//       data.location.split(", ").length !== 4 ||
//       !data.location.endsWith("TP.HCM")
//     )
//       errors.push(
//         "Location must include house number, street, district, and TP.HCM"
//       );
//     if (!data.packageId) errors.push("Package ID is required");
//     if (data.price === 0) errors.push("Total price cannot be zero");
//     if (!data.range || !/^\d+-\d+$/.test(data.range))
...
//             {selectedCharacters.length > 0
//               ? selectedCharacters
//                   .map((sc) => `${sc.characterName} (Qty: ${sc.quantity || 1})`)
//                   .join(" | ")
//               : "None"}
//           </p>
//           <p>
//             <strong>Estimated price (excluding cosplayer):</strong>{" "}
//             {(() => {
//               const eventData = getEventDataFromLocalStorage();
//               const price = eventData?.price || 0;
//               return price
